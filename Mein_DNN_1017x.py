...
class dynNN:
    ...
    def __init__(self,inputnodes, hiddennodes, outputnodes, learningrate, stufenwert, maxverzoegerung):
        ...
        # D[1]
        # D[2] etc.
        self.D_start = numpy.random.randint(self.mverz, size=(self.dnodes))+1 # Dämfungsnode liegt immer zwischen 1 und maxverzoegerung
    ...
    # Verzögerung Dämpfungsneuronen um eins verkleinern
    def daempf_runter(self):
        print("cccc daempf runter cccc")
        print("D voher=== ", self.D_akt)
        for i in range(self.hnodes):
            self.D_akt[i] = self.D_akt[i] -1
        print("D nachher=== ", self.D_akt)
        pass
